...
namespace LlmTornado.Code
{
    ...
    public class ChatMessageAudio : IChatAudio
    {
        ...
        /// </summary>
        public byte[] ByteData => Data is null ? Array.Empty<byte>() : Convert.FromBase64String(Data);
    ...
    public class ToolArguments
    {
        ...
        public string Data
        {
            ...
            {
                _data = value;
                DecodedArguments = Data.IsNullOrWhiteSpace() ? new Dictionary<string, object?>() : JsonConvert.DeserializeObject<Dictionary<string, object?>>(Data);
            }
        }
        ...
        /// </summary>
        public Dictionary<string, object?> Arguments => ArgGetter.Value.Source ?? new Dictionary<string, object?>();
    ...
    public class ChatSearchResult
    {
        ...
        /// </summary>
        [JsonProperty("content")]
        public List<ChatSearchResultContent> Content { get; set; } = new List<ChatSearchResultContent>();
        ...
        public override IFunctionResultBlock? ReadJson(JsonReader reader, Type objectType, IFunctionResultBlock? existingValue, bool hasExistingValue, JsonSerializer serializer)
        {
            ...
            switch (type)
            {
                ...
                case "search_result":
                {
                    ...
                    {
                        sr.Content = contentArr.ToObject<List<ChatSearchResultContent>>(serializer) ?? new List<ChatSearchResultContent>();
                    }
