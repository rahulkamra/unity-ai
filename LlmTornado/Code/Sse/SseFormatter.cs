...
namespace LlmTornado.Code.Sse
{
    ...
    {
        private static readonly byte[] s_newLine = System.Text.Encoding.UTF8.GetBytes("\n");
            ...
            TimeSpan? reconnectionInterval)
        {
            ...
            {
                bufferWriter.WriteUtf8String(System.Text.Encoding.UTF8.GetBytes("event: "));
                bufferWriter.WriteUtf8String(eventType);
                bufferWriter.WriteUtf8String(s_newLine);
            }

            WriteLinesWithPrefix(bufferWriter, prefix: System.Text.Encoding.UTF8.GetBytes("data: "), data);
            bufferWriter.Write(s_newLine);

            if (eventId is not null)
            {
                bufferWriter.WriteUtf8String(System.Text.Encoding.UTF8.GetBytes("id: "));
            ...
            if (reconnectionInterval is { } retry)
            {
                ...
                bufferWriter.WriteUtf8String(System.Text.Encoding.UTF8.GetBytes("retry: "));
