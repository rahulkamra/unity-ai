...
namespace LlmTornado.Code
{
    internal static partial class Extensions
    {
        ...
        private static readonly ConcurrentDictionary<string, string?> DescriptionAttrCache = new ConcurrentDictionary<string, string?>();
        ...
        private static readonly HashSet<string> truthyStrings = new HashSet<string> { "1", "on", "true", "True", "TRUE", "yes", "ok", "success" };
