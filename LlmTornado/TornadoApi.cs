...
namespace LlmTornado
{
    ...
    {
        internal readonly ConcurrentDictionary<LLmProviders, ProviderAuthentication> Authentications = new ConcurrentDictionary<LLmProviders, ProviderAuthentication>();
        internal readonly ConcurrentDictionary<LLmProviders, IEndpointProvider> EndpointProviders = new ConcurrentDictionary<LLmProviders, IEndpointProvider>();
