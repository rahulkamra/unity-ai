...
namespace LlmTornado.Common
{
    ...
    public class Tool
    {
        ...
        private ConcurrentDictionary<int, ToolFunction>? serializedDict = new ConcurrentDictionary<int, ToolFunction>();
        ...
        internal void Serialize(IEndpointProvider provider, int functionIndex)
        {
            ...
            serializedDict ??= new ConcurrentDictionary<int, ToolFunction>();
