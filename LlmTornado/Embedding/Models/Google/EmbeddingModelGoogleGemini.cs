...
namespace LlmTornado.Embedding.Models.Google
{
    ...
    public class EmbeddingModelGoogleGemini : IVendorModelClassProvider
    {
        ...
        /// </summary>
        public static readonly EmbeddingModel ModelGeminiEmbedding001 = new EmbeddingModel("gemini-embedding-001", LLmProviders.Google, 2_048, 3072, new List<int> { 1536, 768 });
