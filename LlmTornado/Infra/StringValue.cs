...
namespace LlmTornado.Infra
{
    ...
    {
        internal static readonly ConcurrentDictionary<string, object?> Cache = new ConcurrentDictionary<string, object?>();
        ...
        public static Dictionary<string, object?> ComponentToDictionary(this object source, BindingFlags bindingAttr = BindingFlags.DeclaredOnly | BindingFlags.Public | BindingFlags.Instance)
        {
            ...
            {
                props = cachedProps ?? new List<PropertyInfo>();
            }
            else
            {
    ...
    {
        private static readonly ConcurrentDictionary<Enum, string?> StringValues = new ConcurrentDictionary<Enum, string?>();
        private static readonly ConcurrentDictionary<Enum, ConcurrentDictionary<string, string?>> StringValuesWithKeys = new ConcurrentDictionary<Enum, ConcurrentDictionary<string, string?>>();
        private static readonly ConcurrentDictionary<Enum, object?> TypeValues = new ConcurrentDictionary<Enum, object?>();
        private static readonly ConcurrentDictionary<Enum, ConcurrentDictionary<string, object?>> TypeValuesWithKeys = new ConcurrentDictionary<Enum, ConcurrentDictionary<string, object?>>();
