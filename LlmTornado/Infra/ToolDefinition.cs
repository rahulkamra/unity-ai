...
namespace LlmTornado.Infra
{
    ...
    {
        public static readonly List<string> DiscriminatorKeys = new List<string> { "type", "_type", "discriminator_type", "discriminator" };
    }
    ...
    public class ToolParamAnyOf : ToolParamTypeBase
    {
        ...
        /// </summary>
        [JsonProperty("anyOf")]
        public List<IToolParamType> AnyOf { get; set; } = new List<IToolParamType>();

        /// <summary>
        /// The list of possible CLR types, used for deserialization.
        /// </summary>
        [JsonIgnore]
        public List<Type> PossibleTypes { get; set; } = new List<Type>();
    ...
    public class ToolParamDictionary : ToolParamTypeBase
    {
        ...
        public override object Compile(ToolDefinition sourceFn, ToolMeta meta)
        {
            ...
            try
            {
                ...
                ToolParamObject itemsSchema = new ToolParamObject("A key-value pair for the dictionary.", new List<ToolParam>
                {
