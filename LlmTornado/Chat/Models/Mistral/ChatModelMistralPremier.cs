...
namespace LlmTornado.Chat.Models.Mistral
{
    ...
    public class ChatModelMistralPremier : IVendorModelClassProvider
    {
        ...
        /// </summary>
        public static readonly ChatModel ModelCodestral2508 = new ChatModel("codestral-2508", LLmProviders.Mistral, 256_000, new List<string> { "codestral-latest" });
        ...
        /// </summary>
        public static readonly ChatModel ModelMistralLarge = new ChatModel("mistral-large-2411", LLmProviders.Mistral, 128_000, new List<string> { "mistral-large-latest" });
        ...
        /// </summary>
        public static readonly ChatModel ModelPixtralLarge = new ChatModel("pixtral-large-2411", LLmProviders.Mistral, 128_000, new List<string> { "pixtral-large-latest" });
        ...
        /// </summary>
        public static readonly ChatModel ModelMistralSaba = new ChatModel("mistral-saba-2502", LLmProviders.Mistral, 32_000, new List<string> { "mistral-saba-latest" });
        ...
        /// </summary>
        public static readonly ChatModel ModelMinistral3B = new ChatModel("ministral-3b-2410", LLmProviders.Mistral, 128_000, new List<string> { "ministral-3b-latest" });
        ...
        /// </summary>
        public static readonly ChatModel ModelMinistral8B = new ChatModel("ministral-8b-2410", LLmProviders.Mistral, 128_000, new List<string> { "ministral-8b-latest" });
        ...
        /// </summary>
        public static readonly ChatModel ModelMedium3 = new ChatModel("mistral-medium-2505", LLmProviders.Mistral, 128_000, new List<string> { "mistral-medium-latest" });
