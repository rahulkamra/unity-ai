...
namespace LlmTornado.Chat.Models.Mistral
{
    ...
    public class ChatModelMistral: BaseVendorModelProvider
    {
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => ChatModelMistralPremier.ModelsAll.Concat(ChatModelMistralFree.ModelsAll).Concat(ChatModelMistralResearch.ModelsAll).ToList());
