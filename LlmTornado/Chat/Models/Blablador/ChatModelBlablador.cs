...
namespace LlmTornado.Chat.Models
{
    ...
    public class ChatModelBlablador : BaseVendorModelProvider
    {
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() =>
        {
            ...
            list.AddRange(ChatModelBlabladorAliases.ModelsAll);
            list.AddRange(ChatModelBlabladorQwen.ModelsAll);
            list.AddRange(ChatModelBlabladorMistral.ModelsAll);
            list.AddRange(ChatModelBlabladorOthers.ModelsAll);
            list.AddRange(ChatModelBlabladorCompatibility.ModelsAll);
            return list;
        });
