...
namespace LlmTornado.Chat.Models
{
    ...
    public class ChatModelGroq : BaseVendorModelProvider
    {
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => ChatModelGroqMeta.ModelsAll.Concat(ChatModelGroqGoogle.ModelsAll).Concat(ChatModelGroqGroq.ModelsAll).Concat(ChatModelGroqMistral.ModelsAll).Concat(ChatModelGroqAlibaba.ModelsAll).Concat(ChatModelGroqMoonshotAi.ModelsAll).Concat(ChatModelGroqOpenAi.ModelsAll).ToList());
