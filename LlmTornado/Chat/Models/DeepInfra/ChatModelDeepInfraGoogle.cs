...
namespace LlmTornado.Chat.Models.DeepInfra
{
    ...
    public class ChatModelDeepInfraGoogle : IVendorModelClassProvider
    {
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => new List<IModel> {ModelGemini25Pro, ModelGemini25Flash, ModelGemini20Flash001, ModelGemma327BIt, ModelGemma312BIt, ModelGemma34BIt});
