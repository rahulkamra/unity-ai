...
namespace LlmTornado.Chat.Models.DeepInfra
{
    ...
    public class ChatModelDeepInfra : BaseVendorModelProvider
    {
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => ChatModelDeepInfraDeepSeek.ModelsAll.Concat(ChatModelDeepInfraQwen.ModelsAll).Concat(ChatModelDeepInfraMeta.ModelsAll).Concat(ChatModelDeepInfraMicrosoft.ModelsAll).Concat(ChatModelDeepInfraGoogle.ModelsAll).Concat(ChatModelDeepInfraMistral.ModelsAll).Concat(ChatModelDeepInfraNemotron.ModelsAll).Concat(ChatModelDeepInfraAnthropic.ModelsAll).ToList());
