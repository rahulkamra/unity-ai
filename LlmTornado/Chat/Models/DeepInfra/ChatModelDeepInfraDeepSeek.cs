...
namespace LlmTornado.Chat.Models.DeepInfra
{
    ...
    public class ChatModelDeepInfraDeepSeek : IVendorModelClassProvider
    {
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => new List<IModel> {ModelV32Exp, ModelV31Terminus, ModelV31, ModelV3, ModelR1, ModelR10528, ModelR1Turbo, ModelR10528Turbo, ModelProverV2671B, ModelR1DistillLlama70B, ModelR1DistillQwen32B});
