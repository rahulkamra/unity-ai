...
namespace LlmTornado.Chat.Models.DeepInfra
{
    ...
    public class ChatModelDeepInfraMicrosoft : IVendorModelClassProvider
    {
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => new List<IModel> {ModelPhi4, ModelPhi4MultimodalInstruct, ModelPhi4ReasoningPlus});
