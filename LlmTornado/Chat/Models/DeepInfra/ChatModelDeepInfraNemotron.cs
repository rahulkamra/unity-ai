...
namespace LlmTornado.Chat.Models.DeepInfra
{
    ...
    public class ChatModelDeepInfraNemotron : IVendorModelClassProvider
    {
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => new List<IModel> {ModelLlama31Nemotron70BInstruct, ModelLlama33NemotronSuper49BV15, ModelNVIDIANemotronNano9BV2});
