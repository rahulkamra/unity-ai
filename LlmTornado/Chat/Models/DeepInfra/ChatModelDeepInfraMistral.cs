...
namespace LlmTornado.Chat.Models.DeepInfra
{
    ...
    public class ChatModelDeepInfraMistral : IVendorModelClassProvider
    {
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => new List<IModel> {ModelMistralSmall3224BInstruct2506, ModelMistralSmall3124BInstruct2503, ModelMistralSmall24BInstruct2501, ModelMistral7BInstructV03, ModelMistralNemoInstruct2407, ModelMixtral8x7BInstructV01, ModelDevstralSmall2507});
