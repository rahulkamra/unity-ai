...
namespace LlmTornado.Chat.Models
{
    ...
    public class ChatModelOpenAiGpt5 : IVendorModelClassProvider
    {
        ...
        /// </summary>
        public static readonly ChatModel ModelV5Pro = new ChatModel("gpt-5-pro", LLmProviders.OpenAi, 400_000, new List<string> { "gpt-5-pro-2025-10-06" })
        {
        ...
        /// </summary>
        public static readonly ChatModel ModelV5Codex = new ChatModel("gpt-5-codex", LLmProviders.OpenAi, 400_000, new List<string>())
        {
            EndpointCapabilities = new HashSet<ChatModelEndpointCapabilities> { ChatModelEndpointCapabilities.Responses, ChatModelEndpointCapabilities.Batch }
        };
        ...
        {
            EndpointCapabilities = new HashSet<ChatModelEndpointCapabilities> { ChatModelEndpointCapabilities.Chat }
        };
        ...
        /// </summary>
        public static readonly ChatModel ModelV5 = new ChatModel("gpt-5", LLmProviders.OpenAi, 400_000, new List<string> { "gpt-5-2025-08-07" })
        {
        ...
        /// </summary>
        public static readonly ChatModel ModelV5Mini = new ChatModel("gpt-5-mini", LLmProviders.OpenAi, 400_000, new List<string> { "gpt-5-mini-2025-08-07" })
        {
            EndpointCapabilities = new HashSet<ChatModelEndpointCapabilities> { ChatModelEndpointCapabilities.Responses, ChatModelEndpointCapabilities.Chat, ChatModelEndpointCapabilities.Batch }
        };
        ...
        /// </summary>
        public static readonly ChatModel ModelV5Nano = new ChatModel("gpt-5-nano", LLmProviders.OpenAi, 400_000, new List<string> { "gpt-5-nano-2025-08-07" });
        ...
        /// </summary>
        public static readonly ChatModel ModelRealtimeMini = new ChatModel("gpt-realtime-mini", LLmProviders.OpenAi, 128_000, new List<string> { "gpt-realtime-mini-2025-12-15", "gpt-realtime-mini-2025-10-06" })
        {
            EndpointCapabilities = new HashSet<ChatModelEndpointCapabilities> { ChatModelEndpointCapabilities.Responses }
        };
