...
namespace LlmTornado.Chat.Models
{
    ...
    public class ChatModelOpenAiGpt4 : IVendorModelClassProvider
    {
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => new List<IModel> { ModelOMini, ModelOMini240718, ModelO, ModelO240513, ModelO240806, ModelO241120, ModelChatGptLatest, ModelTurbo, ModelTurbo240409, ModelPreview240125, ModelPreview231106, ModelVisionPreview231106, ModelDefault, ModelPreview230613, ModelContext32K, ModelContext32K230613, ModelO1Pro, ModelO1, ModelO1240912, ModelO1Mini, ModelO1Mini240912, ModelAudioPreview, ModelAudioPreview241001, ModelO1241217, ModelAudioPreview241217, ModelOSearchPreview, ModelOMiniSearchPreview, ModelAudioPreview250603 });
        ...
        {
            HashSet<IModel> set = new HashSet<IModel>(ChatModelOpenAiO3.ModelsAll);
            set.Add(ModelO1Pro);
            set.Add(ModelO1);
            set.Add(ModelO1240912);
            set.Add(ModelO1Mini);
            set.Add(ModelO1Mini240912);
            set.Add(ModelO1241217);
            return set;
        });
