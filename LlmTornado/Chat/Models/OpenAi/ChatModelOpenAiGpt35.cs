...
namespace LlmTornado.Chat.Models
{
    ...
    public class ChatModelOpenAiGpt35 : IVendorModelClassProvider
    {
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => new List<IModel> {ModelTurbo, ModelTurbo240125, ModelTurbo231106, ModelTurboInstruct});
