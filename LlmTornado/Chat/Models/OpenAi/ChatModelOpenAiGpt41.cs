...
namespace LlmTornado.Chat.Models
{
    ...
    public class ChatModelOpenAiGpt41 : IVendorModelClassProvider
    {
        ...
        /// </summary>
        public static readonly ChatModel ModelV41 = new ChatModel("gpt-4.1", LLmProviders.OpenAi, 1_000_000, new List<string> { "gpt-4.1-2025-04-14" })
        {
        ...
        /// </summary>
        public static readonly ChatModel ModelV41Mini = new ChatModel("gpt-4.1-mini", LLmProviders.OpenAi, 1_000_000, new List<string> { "gpt-4.1-mini-2025-04-14" })
        {
            EndpointCapabilities = new HashSet<ChatModelEndpointCapabilities> { ChatModelEndpointCapabilities.Responses, ChatModelEndpointCapabilities.Chat, ChatModelEndpointCapabilities.Batch }
        };
        ...
        /// </summary>
        public static readonly ChatModel ModelV41Nano = new ChatModel("gpt-4.1-nano", LLmProviders.OpenAi, 1_000_000, new List<string> { "gpt-4.1-nano-2025-04-14" });
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => new List<IModel> { ModelV41, ModelV41Mini, ModelV41Nano });
