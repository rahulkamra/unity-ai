...
namespace LlmTornado.Chat.Models
{
    ...
    public class ChatModelOpenAiO3 : IVendorModelClassProvider
    {
        ...
        /// </summary>
        public static readonly ChatModel ModelV3DeepResearch = new ChatModel("o3-deep-research", LLmProviders.OpenAi, 200_000, new List<string> { "o3-deep-research-2025-06-26" })
        {
        ...
        /// </summary>
        public static readonly ChatModel ModelV3 = new ChatModel("o3", LLmProviders.OpenAi, 200_000, new List<string> { "o3-2025-04-16" });
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => new List<IModel> { ModelMini250131, ModelMini, ModelV3, ModelV3DeepResearch });
