...
namespace LlmTornado.Chat.Models.Alibaba
{
    ...
    public class ChatModelAlibaba : BaseVendorModelProvider
    {
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() =>
        {
            ...
            list.AddRange(ChatModelAlibabaFlagship.ModelsAll);
            list.AddRange(ChatModelAlibabaCostOptimized.ModelsAll);
            list.AddRange(ChatModelAlibabaVisual.ModelsAll);
            list.AddRange(ChatModelAlibabaMultimodal.ModelsAll);
            list.AddRange(ChatModelAlibabaEmbeddings.ModelsAll);
            list.AddRange(ChatModelAlibabaReasoning.ModelsAll);
            list.AddRange(ChatModelAlibabaOlder.ModelsAll);
            return list;
        });
