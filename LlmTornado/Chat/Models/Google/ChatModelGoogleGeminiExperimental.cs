...
namespace LlmTornado.Chat.Models
{
    ...
    public class ChatModelGoogleGeminiExperimental : IVendorModelClassProvider
    {
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => new List<IModel> {ModelGemini2FlashThinkingExp250121, ModelLearnLlm15ProExperimental, ModelGemini2ProExp250205, ModelGemini2FlashImageGeneration, ModelGemini2ProExp0325});
