...
namespace LlmTornado.Chat.Models.Perplexity
{
    ...
    public class ChatModelPerplexitySonar : IVendorModelClassProvider
    {
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => new List<IModel> {ModelPro, ModelDefault, ModelDeepResearch, ModelReasoningPro, ModelReasoning});
