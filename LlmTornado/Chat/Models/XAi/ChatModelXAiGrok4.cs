...
namespace LlmTornado.Chat.Models.XAi
{
    ...
    public class ChatModelXAiGrok4 : IVendorModelClassProvider
    {
        ...
        /// </summary>
        public static readonly ChatModel ModelV4 = new ChatModel("grok-4", LLmProviders.XAi, 256_000, new List<string> { "grok-4-0709", "grok-4-latest" });
        ...
        /// </summary>
        public static readonly ChatModel ModelV4FastReasoning = new ChatModel("grok-4-fast-reasoning", LLmProviders.XAi, 2_000_000, new List<string> { "grok-4-fast", "grok-4-fast-reasoning-latest" });
        ...
        /// We're excited to release grok-4-fast, our latest advancement in cost-efficient reasoning models.
        /// </summary>
        public static readonly ChatModel ModelV4FastNonReasoning = new ChatModel("grok-4-fast-non-reasoning", LLmProviders.XAi, 2_000_000, new List<string> { "grok-4-fast-non-reasoning-latest" });
