...
namespace LlmTornado.Chat.Models.XAi
{
    ...
    public class ChatModelXAiGrok3 : IVendorModelClassProvider
    {
        ...
        /// </summary>
        public static readonly ChatModel ModelV3 = new ChatModel("grok-3", LLmProviders.XAi, 131_072, new List<string> { "grok-3-beta", "grok-3-latest" });
        ...
        /// Our flagship model that excels at enterprise use cases like data extraction, coding, and text summarization. Possesses deep domain knowledge in finance, healthcare, law, and science.
        /// </summary>
        public static readonly ChatModel ModelV3Fast = new ChatModel("grok-3-fast", LLmProviders.XAi, 131_072, new List<string> { "grok-3-fast-beta", "grok-3-fast-latest" });
        ...
        /// </summary>
        public static readonly ChatModel ModelV3Mini = new ChatModel("grok-3-mini", LLmProviders.XAi, 131_072, new List<string> { "grok-3-mini-beta", "grok-3-mini-latest" });
        ...
        /// A lightweight model that thinks before responding. Fast, smart, and great for logic-based tasks that do not require deep domain knowledge. The raw thinking traces are accessible.
        /// </summary>
        public static readonly ChatModel ModelV3MiniFast = new ChatModel("grok-3-mini-fast", LLmProviders.XAi, 131_072, new List<string> { "grok-3-mini-fast-beta", "grok-3-mini-fast-latest" });
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => new List<IModel> {ModelV3, ModelV3Fast, ModelV3Mini, ModelV3MiniFast});
