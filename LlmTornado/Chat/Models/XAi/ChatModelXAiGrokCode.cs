...
namespace LlmTornado.Chat.Models.XAi
{
    ...
    public class ChatModelXAiGrokCode : IVendorModelClassProvider
    {
        ...
        /// </summary>
        public static readonly ChatModel ModelFast1 = new ChatModel("grok-code-fast-1", LLmProviders.XAi, 256_000, new List<string> { "grok-code-fast", "grok-code-fast-1-0825" });
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => new List<IModel> {ModelFast1});
