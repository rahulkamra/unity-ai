...
namespace LlmTornado.Chat.Models.XAi
{
    ...
    public class ChatModelXAi : BaseVendorModelProvider
    {
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => ChatModelXAiGrok.ModelsAll.Concat(ChatModelXAiGrok3.ModelsAll).Concat(ChatModelXAiGrok4.ModelsAll).Concat(ChatModelXAiGrok41.ModelsAll).Concat(ChatModelXAiGrokCode.ModelsAll).ToList());
