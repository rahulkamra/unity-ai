...
namespace LlmTornado.Chat.Models.XAi
{
    ...
    public class ChatModelXAiGrok : IVendorModelClassProvider
    {
        ...
        /// </summary>
        public static readonly ChatModel ModelGrok2241212 = new ChatModel("grok-2-1212", LLmProviders.XAi, 200_000, new List<string> { "grok-2", "grok-2-latest" });
        ...
        /// Our latest text model supporting structured outputs, with improved efficiency, speed and capabilities.
        /// </summary>
        public static readonly ChatModel ModelGrok2Vision241212 = new ChatModel("grok-2-vision-1212", LLmProviders.XAi, 200_000, new List<string> { "grok-2-vision", "grok-2-vision-latest" });
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => new List<IModel> {ModelGrok2241212, ModelGrok2Vision241212, ModelGrokBeta, ModelGrokVisionBeta});
