...
namespace LlmTornado.Chat.Models
{
    ...
    public class ChatModelAnthropic : BaseVendorModelProvider
    {
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => ChatModelAnthropicClaude3.ModelsAll.Concat(ChatModelAnthropicClaude35.ModelsAll).Concat(ChatModelAnthropicClaude4.ModelsAll).Concat(ChatModelAnthropicClaude41.ModelsAll).Concat(ChatModelAnthropicClaude45.ModelsAll).Concat(ChatModelAnthropicClaude46.ModelsAll).ToList());
