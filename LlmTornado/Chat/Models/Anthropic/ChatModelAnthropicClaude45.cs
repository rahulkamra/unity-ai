...
namespace LlmTornado.Chat.Models
{
    ...
    public class ChatModelAnthropicClaude45 : IVendorModelClassProvider
    {
        ...
        /// </summary>
        public static readonly ChatModel ModelHaiku251001 = new ChatModel("claude-haiku-4-5-20251001", LLmProviders.Anthropic, 200_000, new List<string> { "claude-haiku-4-5" });
        ...
        /// </summary>
        public static readonly ChatModel ModelSonnet250929 = new ChatModel("claude-sonnet-4-5-20250929", LLmProviders.Anthropic, 200_000, new List<string> { "claude-sonnet-4-5" });
        ...
        /// </summary>
        public static readonly ChatModel ModelOpus251101 = new ChatModel("claude-opus-4-5-20251101", LLmProviders.Anthropic, 200_000, new List<string> { "claude-opus-4-5" });
