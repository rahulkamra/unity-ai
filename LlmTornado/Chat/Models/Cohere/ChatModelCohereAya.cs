...
namespace LlmTornado.Chat.Models
{
    ...
    public class ChatModelCohereAya : IVendorModelClassProvider
    {
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => new List<IModel> {ModelExpanse8B, ModelExpanse32B, ModelVision8B, ModelVision32B});
