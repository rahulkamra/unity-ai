...
namespace LlmTornado.Chat.Models
{
    ...
    public class ChatModelCohereCommand : IVendorModelClassProvider
    {
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => new List<IModel> {ModelRPlus2408, ModelNightly, ModelDefault, ModelDefault2408, ModelLightNightly, ModelR7B, ModelR7BArabic2412, ModelA0325, ModelAVision2507, ModelAReasoning2508, ModelATranslate2508});
