...
namespace LlmTornado.Chat.Models
{
    ...
    public class ChatModelCohere: BaseVendorModelProvider
    {
        ...
        private static readonly Lazy<List<IModel>> LazyModelsAll = new Lazy<List<IModel>>(() => ChatModelCohereCommand.ModelsAll.Concat(ChatModelCohereAya.ModelsAll).ToList());
