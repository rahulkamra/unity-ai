...
namespace LlmTornado.Chat.Vendors.Cohere
{
    ...
    public class ChatResponseVendorCohereExtensions
    {
        ...
        {
            return new List<VendorCohereCitationBlock>(); // ParseCitations(Response.Message ?? string.Empty);
        }
        ...
        {
            List<VendorCohereCitationBlock> blocks = new List<VendorCohereCitationBlock>();
            int pos = 0;
