...
namespace LlmTornado.Code.Vendor
{
    ...
    public class CohereEndpointProvider : BaseEndpointProvider, IEndpointProvider, IEndpointProviderExtended
    {
        ...
        private static readonly string StreamMsgStart = Event + " message_start";
        private static readonly string StreamMsgStop = Event + " message_stop";
        private static readonly string StreamPing = Event + " ping";
        private static readonly string StreamContentBlockDelta = Event + " content_block_delta";
        private static readonly string StreamContentBlockStart = Event + " content_block_start";
        private static readonly string StreamContentBlockStop = Event + " content_block_stop";
        private static readonly HashSet<string> StreamSkip = new HashSet<string> { StreamMsgStart, StreamMsgStop, StreamPing };
        ...
        public override async IAsyncEnumerable<ChatResult?> InboundStream(StreamReader reader, ChatRequest request, ChatStreamEventHandler? eventHandler)
        {
            ...
            List<ToolCall> finalizedToolCalls = new List<ToolCall>();
